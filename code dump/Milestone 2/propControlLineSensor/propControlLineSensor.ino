...
static int LTurnL = 60; 
static int LTurnR = 60; 

static int RTurnL = 150; 
...
void loop() {
  while (Go) { 
    ...
    total = line[1] + abs(line[2]- line[0]);
    error = botpos/total; 
    Serial.print(line[0]);
    Serial.print("\t");
    Serial.print(line[1]);
...
//      if (!(line[1]>850 && line[0] <750 && line[2] <750) | !passed) {
//        if (line[1]<750) {
//          passed = true; 
//        }
//        break;
...
//    }
    ...
    rightWheel = newRight;
    // junction
//    if (line[1] >850 && line[2] >850 &&line[0] >850) {
//      Serial.println("Junction");
//      hitAJunction = true; 
//   
//    }
//
//      if (hitAJunction && (line[0]<750 && line[1] >850 && line[2] <750)) {
//        if ((count == 0) | (count > 4)) {
//          leftWheel = LTurnL;
//          rightWheel = LTurnR;
//          if (count == 7){
